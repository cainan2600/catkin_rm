...
i = return_max('\\home\\xps\\Desktop\\NSAI_new\\src\\alg_train\\vgg_for_mir_aligned\\data\\A\\*.jpg')
while True:
    ...
    # 输入空格保存图片
        ...
        i = i + 1
        cv2.imwrite(os.path.join("/home/xps/Desktop/NSAI_new/src/alg_train/vgg_for_mir_aligned/data/A", str(i) + '.jpg'), color_img)
