...
config.enable_stream(rs.stream.depth, 640, 480, rs.format.z16, 30)  # 修改这里的分辨率为与彩色图相同

pipeline_profile = pipeline.start(config)
align_to = rs.stream.color
align = rs.align(align_to)
colorizer = rs.colorizer()
# i = return_max('/home/xps/peng_for_mobilvit_mmpretrain/data/original_data/5_obs/RGB/*.jpg')
i = return_max('/home/xps/peng_for_mobilvit_mmpretrain/data/original_data2/*.jpg')
...
while True:
    ...
    aligned_depth_frame = aligned_frames.get_depth_frame()  # 修改这里获取深度图像的方法
    aligned_color_frame = aligned_frames.get_color_frame()

    if not aligned_depth_frame or not aligned_color_frame:
        continue

    depth_img = np.asanyarray(colorizer.colorize(aligned_depth_frame).get_data())
    ...
    if k == 27:  # Esc退出
        ...
        i += 1
        cv2.imwrite(os.path.join("/home/xps/peng_for_mobilvit_mmpretrain/data/original_data2", str(i) + '_color.jpg'), color_img)
        cv2.imwrite(os.path.join("/home/xps/peng_for_mobilvit_mmpretrain/data/original_data2", str(i) + '_depth.jpg'), depth_img)
...
# align = rs.align(align_to)
# colorizer = rs.colorizer()
# i = return_max('/home/xps/peng_for_mobilvit_mmpretrain/data/original_data/5_obsfree/*.jpg')
...
#     elif k == ord(' '):
#         i = i + 1
#         cv2.imwrite(os.path.join("/home/xps/peng_for_mobilvit_mmpretrain/data/original_data/5_obsfree", str(i) + '.jpg'), color_img)
#         cv2.imwrite(os.path.join("/home/xps/peng_for_mobilvit_mmpretrain/data/original_data/5_obsfree", str(i) + '.jpg'), depth_img)
