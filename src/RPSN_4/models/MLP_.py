...
class MLP_self(nn.Module):
    def __init__(self, num_i, num_h, num_o, num_heads):
        ...
        self.linear1 = torch.nn.Linear(num_i, num_h) # 6x32
        self.linear1.activation = 'relu'
        self.relu1 = torch.nn.ReLU()
        # self.tanh1 = torch.nn.Tanh()
        # self.leak_relu1 = torch.nn.PReLU()

        self.linear2 = torch.nn.Linear(num_h, 2*num_h) # 32x64
        self.linear2.activation = 'relu'
        self.relu2 = torch.nn.ReLU()
        # self.tanh1 = torch.nn.Tanh()
        # self.leak_relu1 = torch.nn.PReLU()

        self.linear3 = torch.nn.Linear(2*num_h, 4*num_h) # 64x128
        self.linear3.activation = 'relu'
        self.relu3 = torch.nn.ReLU()
        # self.tanh1 = torch.nn.Tanh()
        # self.leak_relu1 = torch.nn.PReLU()

        self.linear4 = torch.nn.Linear(4*num_h, 8*num_h) # 128x256
        self.linear4.activation = 'relu'
        self.relu4 = torch.nn.ReLU()
        # self.tanh1 = torch.nn.Tanh()
        # self.leak_relu1 = torch.nn.PReLU()

        self.linear5 = torch.nn.Linear(8*num_h, 8*num_h) # 256x256
        self.linear5.activation = 'relu'
        self.relu5 = torch.nn.ReLU()
        # self.tanh2 = torch.nn.Tanh()
        # self.leak_relu2 = torch.nn.PReLU()

        self.linear6 = torch.nn.Linear(8*num_h, 4*num_h) # 256x128
        self.linear6.activation = 'relu'
        self.relu6 = torch.nn.ReLU()
        # self.tanh2 = torch.nn.Tanh()
        # self.leak_relu2 = torch.nn.PReLU()

        self.linear7 = torch.nn.Linear(4*num_h, 2*num_h) # 128X64
        self.linear7.activation = 'relu'
        self.relu7 = torch.nn.ReLU()
        # self.tanh2 = torch.nn.Tanh()
        # self.leak_relu2 = torch.nn.PReLU()

        self.linear8 = torch.nn.Linear(2*num_h, num_h) # 64x32
        self.linear8.activation = 'relu'
        self.relu8 = torch.nn.ReLU()
        # self.tanh2 = torch.nn.Tanh()
        # self.leak_relu2 = torch.nn.PReLU()

        self.linear9 = torch.nn.Linear(num_h, num_o)
    ...
    def forward(self, input_tensor):
        ...
        for i in range(1, input_tensor.size(0)):
            ...
            if is_duplicate:
                mask[i] = 0
        # print(mask)
        # mask = torch.FloatTensor([0,0,0,1,1,1])
