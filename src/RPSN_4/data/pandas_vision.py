...
# 文件名，可替换为实际使用的文件名
filename = "/home/cn/catkin_rm/src/RPSN_4/work_dir/test07-1-loss2/NET_output.txt"
...
fig = ax.get_figure()
fig.savefig('/home/cn/catkin_rm/src/RPSN_4/work_dir/test07-1-loss2/NET_output.png')
