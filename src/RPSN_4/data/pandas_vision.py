...
# 文件名，可替换为实际使用的文件名
filename = "/home/cn/catkin_rm/src/RPSN_4/data/data_cainan/rm-fk-ik-all-random-with-dipan-norm/train-1000/train_dataset_1000_copy.txt"
...
fig = ax.get_figure()
fig.savefig('/home/cn/catkin_rm/src/RPSN_4/data/data_cainan/rm-fk-ik-all-random-with-dipan-norm/train-1000/train_dataset_1000_copy.png')
